...
export function TomSelectSingle({ options, value, onChange, placeholder, allowEmpty = false, className = '' }: {
    options: Option[];
    value: string | number | '';
    ...
    return (
        <select ref={selectRef} defaultValue={value === '' ? '' : String(value)} className={`${baseClasses} ${className}`}>
