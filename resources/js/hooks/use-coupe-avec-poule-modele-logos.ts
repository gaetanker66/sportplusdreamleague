...
/**
 * Hook pour charger les logos des modèles de coupes avec poules de manière asynchrone
 ...
 */
export function useCoupeAvecPouleModeleLogos(modeleIds: (number | undefined)[]) {
    ...
    useEffect(() => {
        ...
        fetch('/dashboard/api/coupe-avec-poule-modeles/logos', {
            ...
            .catch(error => {
                console.error('Erreur lors du chargement des logos de modèles de coupes avec poules:', error);
    ...
    /**
     * Fonction helper pour obtenir le logo d'un modèle de coupe avec poules
