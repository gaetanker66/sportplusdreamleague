...
export default function EquipesEdit({ equipe, postes = [] as Poste[] }: { equipe: Equipe; postes?: Poste[] }) {
    ...
    const handleUpdatePlayerLocal = (joueur: Joueur, patch: Partial<{ nom: string; poste_id: number | null; postes_secondaires: number[]; photo?: string }>) => {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                ...
                <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
                    <div className="p-6 space-y-6">
                        ...
                        <form onSubmit={handleAddPlayer} className="grid grid-cols-1 lg:grid-cols-4 gap-3 items-end">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <button type="submit" className="self-end inline-flex items-center px-4 py-2 rounded-md text-white bg-blue-600 hover:bg-blue-700">Ajouter</button>
                            </div>
                        </form>
...
function EditablePlayerRow({ joueur, equipeId, postes, onChange, onDelete }: { joueur: Joueur; equipeId: number; postes: Poste[]; onChange: (patch: Partial<{ nom: string; poste_id: number | null; postes_secondaires: number[]; photo?: string }>) => void; onDelete: () => void; }) {
    ...
    // Sauvegarde immédiate des postes secondaires pour éviter toute perte
    React.useEffect(() => {
