...
interface Props { match: Match; homeGardiens: SimplePlayer[]; awayGardiens: SimplePlayer[]; homePlayers: SimplePlayer[]; awayPlayers: SimplePlayer[]; readOnly?: boolean; backUrl?: string }

export default function PouleMatchEdit({ match, homeGardiens, awayGardiens, homePlayers, awayPlayers, readOnly, backUrl }: Props) {
    ...
    return (
        <AppLayout>
            <Head title={`Modifier le match de poule #${match.id}`} />
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div className="flex items-center justify-between">
                    ...
                    <a href={backUrl || '/coupes-avec-poules'} className="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md text-xs text-white uppercase tracking-widest hover:bg-gray-700">Retour</a>
                </div>
